...
const API = axios.create({
  baseURL: import.meta.env.VITE_API_URL || 'https://autodm-backend-consultation-production.up.railway.app/api',
});
...
export const getGoogleStatus    = ()                 => API.get('/calendar/google/status');
export const connectGoogle      = ()                 => API.get('/calendar/google/connect');
